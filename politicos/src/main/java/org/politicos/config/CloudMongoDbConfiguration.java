...
import org.politicos.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("org.politicos.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("org.politicos.config.dbmigrations");
